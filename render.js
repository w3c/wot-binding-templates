...
const coapTemplate = fs.readFileSync("bindings/protocols/coap/template.sparql", "utf-8");
...
mappings.reduce(async (previousPromise, mapping) => {
  ...
  await render(ontologyFile, templateURI, ontologyFile.replace("mapping.ttl", "index.html"));
  await urdf.clear();
}, promiseChain);
